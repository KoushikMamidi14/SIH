  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-xl font-bold text-slate-900">{t.nav?.register || 'Register'}</h2>
        <p className="text-xs text-slate-500 mt-1">Join VyaparMitra and start your rural business journey</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-xs font-bold text-slate-700 mb-1">Create Password / PIN</label>
          <input
            type="password"
            required
            value={password}
